...
process.env.DEBUG = '*LOG* *WARN* *ERROR* *mediasoup-worker*' || '*LOG* *WARN* *ERROR*';
...
const mediasoup = require('../lib/mediasoup.js');
...
const roomOptions = require('./options').roomOptions;
const peerCapabilities = require('./options').peerCapabilities;
